!function(t) {
    ...
    s ? o = a.pointer : d ? o = a.MSPointer : r ? (o = a.touch,
    p = a.mouse) : o = a.mouse;
    var c = {};
    ...
    t.prototype.off = function(t, e) {
        ...
        void 0 === t ? i._handlers_ = {} : void 0 === e ? i._handlers_[t] = null : i._handlers_[t] && i._handlers_[t].indexOf(e) >= 0 && i._handlers_[t].splice(i._handlers_[t].indexOf(e), 1),
        i
    }
    ,
    ...
    e.prototype.buildEl = function(t) {
        ...
        this.ui.active = document.createElement("div"),
            this.ui.back = document.createElement("div"),
            this.ui.front = document.createElement("div"),

        this.ui.el.className = "nipple collection_" + this.collection.id,
        this.ui.active.className = "nipple-active",
        this.ui.back.className = "nipple-back",
        this.ui.front.className = "nipple-front",
        this.ui.el.setAttribute("id", "nipple_" + this.collection.id + "_" + this.id),
        this.ui.el.appendChild(this.ui.active),
    ...
    e.prototype.show = function(t) {
        var e = this;
        return e.options.dataOnly ? e : (clearTimeout(e.removeTimeout),
    ...
    e.prototype.hide = function(t) {
        var e = this;
        return e.options.dataOnly ? e : (e.ui.el.style.opacity = e.options.restOpacity,
    ...
    e.prototype.computeDirection = function(t) {
        ...
        if (o > r && o < 3 * r && !t.lockX ? e = "up" : o > -r && o <= r && !t.lockY ? e = "left" : o > 3 * -r && o <= -r && !t.lockX ? e = "down" : t.lockY || (e = "right"),
    ...
    i.prototype.createNipple = function(t, i) {
        ...
        return s.dataOnly || (c.applyPosition(p.ui.el, r),
    ...
    i.prototype.processOnStart = function(t) {
        var e, i = this, n = i.options, o = i.manager.getIdentifier(t), r = t.force || t.pressure || t.webkitForce || 0, s = {
            x: t.pageX,
            y: t.pageY
        }, d = i.getOrCreate(o, s);
        ...
        if ((e = i.idles.indexOf(d)) >= 0 && i.idles.splice(e, 1),
        i.actives.push(d),
    ...
    i.prototype.getOrCreate = function(t, e) {
        ...
        return /(semi|static)/.test(o.mode) ? (i = n.idles[0]) ? (n.idles.splice(0, 1),
        i) : "semi" === o.mode ? n.createNipple(e, t) : (console.warn("Coudln't find the needed nipple."),
        !1) : i = n.createNipple(e, t)
    }
    ,
    ...
    i.prototype.processOnEnd = function(t) {
        ...
        o && (i.dataOnly || o.hide(function() {
            "dynamic" === i.mode && (o.trigger("removed", o),
        ...
        e.ids.indexOf(o.identifier) >= 0 && e.ids.splice(e.ids.indexOf(o.identifier), 1),
        e.actives.indexOf(o) >= 0 && e.actives.splice(e.actives.indexOf(o), 1),
        /(semi|static)/.test(i.mode) ? e.idles.push(o) : e.nipples.indexOf(o) >= 0 && e.nipples.splice(e.nipples.indexOf(o), 1),
